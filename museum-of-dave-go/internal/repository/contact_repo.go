...
func (r *ContactRepo) ListNames(ctx context.Context) ([]struct{ ID int64; Name string }, error) {
	...
	for rows.Next() {
		var item struct{ ID int64; Name string }
...
func (r *ContactRepo) GetByName(ctx context.Context, name string) (*struct{ ID int64; RelType *string }, error) {
	var c struct{ ID int64; RelType *string }
