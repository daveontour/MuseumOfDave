...
// containing "your_facebook_activity". If uri is provided, validates by checking
// if the URI path exists relative to the found root.
func DetectFacebookExportRoot(directoryPath, uri string) (string, bool) {
	...
	// Strategy 2: URI contains marker
