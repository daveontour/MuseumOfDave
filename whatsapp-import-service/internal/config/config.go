...
func Load() (*Config, error) {
	...
	directoryPath, err := loadDirectoryConfig()
	if err != nil {
...
func loadDirectoryConfig() (string, error) {
	directoryPath := os.Getenv("DIRECTORY_PATH")
	if directoryPath == "" {
		return "", fmt.Errorf("missing required configuration. Set DIRECTORY_PATH environment variable")
	}
