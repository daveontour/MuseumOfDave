...
class Contacts(Base):
    ...
    numemails = Column(Integer, nullable=False, default=0)
    facebookid = Column(Text, nullable=True)
    numfacebook = Column(Integer, nullable=False, default=0)
    whatsappid = Column(Text, nullable=True)
    numwhatsapp = Column(Integer, nullable=False, default=0)
    imessageid = Column(Text, nullable=True)
    numimessages = Column(Integer, nullable=False, default=0)
    smsid = Column(Text, nullable=True)
    numsms = Column(Integer, nullable=False, default=0)
