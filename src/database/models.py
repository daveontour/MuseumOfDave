...
class Contacts(Base):
    ...
    rel_type = Column(Text, default="unknown", nullable=True)
    use_by_ai = Column(Boolean, default=False, nullable=True)
    source=Column(String(255), nullable=True)
    source_reference=Column(String(500), nullable=True)
    is_subject = Column(Boolean, default=False, nullable=True)
    is_group = Column(Boolean, default=False, nullable=True)
    email = Column(Text, nullable=True)
    numemails = Column(Integer, nullable=True, default=0)
    facebookid = Column(Text, nullable=True)
    numfacebook = Column(Integer, nullable=True, default=0)
    whatsappid = Column(Text, nullable=True)
    numwhatsapp = Column(Integer, nullable=True, default=0)
    imessageid = Column(Text, nullable=True)
    numimessages = Column(Integer, nullable=True, default=0)
    smsid = Column(Text, nullable=True)
    numsms = Column(Integer, nullable=True, default=0)
    instagramid = Column(Text, nullable=True)
    numinstagram = Column(Integer, nullable=True, default=0)
    description = Column(Text, nullable=True)
...
class SubjectConfiguration(Base):
    ...
    other_names = Column(Text, nullable=True)  # Comma-separated names
    email_addresses = Column(Text, nullable=True)  # Comma-separated email addresses
